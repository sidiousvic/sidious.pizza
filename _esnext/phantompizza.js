...
`;let O=I.reduce((n,r)=>({...n,[r.split("/").pop().split(".")[0]]:document.getElementById(r.split("/").pop().split(".")[0])}),{score:document.getElementById("score")}),w=document.getElementById("start-screen"),P=document.getElementById("start-screen-text"),s=document.querySelector("canvas");s.ctx=s.getContext("2d"),s.width=innerWidth,s.height=innerHeight;let o={x:s.width/2,y:s.height/2},V={value:0,sprite:O.score},J=Y.reduce((n,r)=>{let z=new Audio(r.url);return z.volume=r.volume,{...n,[r.url.split("/").pop().split(".")[0]]:z}},{});return setInterval(()=>P.innerHTML=P.innerHTML===c?l:c,2e3),addEventListener("resize",()=>(s.width=innerWidth,s.height=innerHeight)),addEventListener("mousemove",({clientX:n,clientY:r})=>(o.x=n,o.y=r)),addEventListener("touchmove",n=>(o.x=n.touches[0].clientX,o.y=n.touches[0].clientY-120),{passive:!1}),addEventListener("touchstart",n=>(o.x=n.touches[0].clientX,o.y=n.touches[0].clientY),{passive:!1}),addEventListener("keydown",n=>n.key==="Enter"&&w.remove()),addEventListener("keydown",n=>n.key==="ArrowUp"&&(o.y-=60)),addEventListener("keydown",n=>n.key==="ArrowRight"&&(o.x+=60)),addEventListener("keydown",n=>n.key==="ArrowDown"&&(o.y+=60)),addEventListener("keydown",n=>n.key==="ArrowLeft"&&(o.x-=60)),addEventListener("click",()=>w.remove()),addEventListener("touchstart",()=>w.remove()),{c:s,mouse:o,sound:J,score:V,sprites:O}};var R=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent);if(R){let e=document.createElement("style");e.textContent=`
    #main {
      display: flex;
      justify-content: center;
      align-items: center;
