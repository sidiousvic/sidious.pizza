(() => {
  ...
  var J = (e) => e / 2,
    R = (e) => J(e.dimension),
    K = (e) => (t) => p(e)(t) <= R(e) + R(t),
    E = (e) => (t) => (s) => K(e)(t) && void s(),
    z = (e) => ((e.x += e.speed.x), (e.y += e.speed.y)),
    C = (e) => (t) => ((e.x = t.x), (e.y = t.y)),
    k = (e) => (t) => (e.sprite = t),
...
`;
      let A = P.reduce(
        ...
        H = document.getElementById("start-screen-text"),
        l = document.querySelector("canvas");
      (l.width = innerWidth), (l.height = innerHeight);
      let o = { x: l.width / 2, y: l.height / 2 },
        Y = { value: 0, sprite: A.score },
        X = U.reduce((n, r) => {
          let I = new Audio(r.url);
          return (
            (I.volume = r.volume),
            { ...n, [r.url.split("/").pop().split(".")[0]]: I }
          );
        }, {});
      return (
        setInterval(() => (H.innerHTML = H.innerHTML === a ? m : a), 2e3),
        addEventListener(
          "resize",
          () => ((l.width = innerWidth), (l.height = innerHeight))
        ),
        ...
        { c: l, mouse: o, sound: X, score: Y, sprites: A }
      );
    };
...
`;
  ...
  var N = [-5, -4, -5, 2, 3, 4, 5],
    _ = 0,
    i = T ? 30 : 50,
    Q = (Math.pow(i, 2) / (innerHeight * innerWidth)) * 1e3,
    j = [
      "Wicked<i>\uFF01</i>",
      "Pie-wack<i>\uFF01</i>",
      "Slice 'n' dice<i>\uFF01</i>",
    ...
    ee = /phantompizza/i.test(location.href),
    {
      sprites: c,
      score: D,
      sound: te,
      ...
      gameTitle: ee ? "PHANTOM PIZZA" : "SIDIOUS.PIZZA",
      displayScore: !0,
      startScreen: !0,
    ...
    ne = {
      player: d(B)(i)(c.player)(_),
      swoosh: d(x(i))(i)(c.swoosh)(_),
      enemies: [d(x(i))(i)(c.enemyr)(u(N))],
    },
    oe = { phantoms: ne, sound: te, score: D, mouse: B };
      ...
      (e) => (
          ...
          () => (
            ...
            ~~e.score.value % 3
              ...
              : ((document.getElementById("score").style.animation =
                  "shake .5s infinite"),
                (D.sprite.innerHTML = u(j).toUpperCase())),
            w(e.phantoms.swoosh),
            e.sound.swoosh.play().catch(() => {}),
            e.phantoms.enemies.push(d(x(i))(i)(c.enemyr)(u(N)))
          )
        ),
        ...
        e.phantoms.enemies.map(
          (t) => (
            ...
            z(t),
            k(t)(t.speed.x < 0 ? c.enemyl : c.enemyr),
            O(t)({ x: innerWidth, y: innerHeight }),
            g(v)(t)
          )
        )
      )
