...
export function optimizePics9000(pages: RawData[]) {
  for (const page of pages) {
    ...
    const picsToOptimize = String(page.content).match(picToOptimizePattern);
    if (picsToOptimize) {
